...
(function(Se, Ie) {
    ...
    function ni(t) {
        return !(J(t) ? t.length : Tt(t) && Object.keys(t).length)
    }
    ...
    function Lt(t) {
        if (si(t)) return t;
        t = q(t);
        const e = Te(t) ? t : t == null ? void 0 : t.ownerDocument;
        return (e == null ? void 0 : e.defaultView) || window
    }

    function Ae(t, e) {
        return t === e || Tt(t) && Tt(e) && Object.keys(t).length === Object.keys(e).length && le(t, (i, s) => i === e[s])
    }
    ...
    function Gs(t, e) {
        ...
        for (const i in t) t = t[i] > e[i] ? Ui(t, i, e[i]) : t;
        return t
    }
    ...
    function rt(t, e, i = 0, s = !1) {
        ...
        return n ? (t = mt(t) ? $t(t) : t === "next" ? i + 1 : t === "previous" ? i - 1 : t === "last" ? n - 1 : e.indexOf(q(t)), s ? K(t, 0, n - 1) : (t %= n, t < 0 ? t + n : t)) : -1
    }
    ...
    function k(t, e, i) {
        ...
        if (X(i)) return (s = q(t)) == null ? void 0 : s.getAttribute(e);
    ...
    function yt(t, e) {
        return e ? E(t).indexOf(q(e)) : N(O(t)).indexOf(t)
    }

    function fe(t) {
        return t = q(t), t && ["origin", "pathname", "search"].every(e => t[e] === location[e])
    }
    ...
    function ui(t) {
        if (fe(t)) {
            const {
                hash: e,
                ownerDocument: i
            } = q(t), s = decodeURIComponent(e).slice(1);
    ...
    function Gi(t, e) {
        return q(Zs(t, q(e), "querySelector"))
    }

    function Fe(t, e) {
        return E(Zs(t, q(e), "querySelectorAll"))
    }

    function Xs(t, e = document) {
        return Te(e) || Js(t).isContextSelector ? e : e.ownerDocument
    }
    const fr = /([!>+~-])(?=\s+[!>+~-]|\s*$)/g,
        pr = /(\([^)]*\)|[^,])+/g,
        Js = ct(t => {
            ...
            if (!t || !H(t)) return {};
            const i = [];
            for (let s of t.match(pr)) s = s.trim().replace(fr, "$1 *"), e || (e = ["!", "+", "~", "-", ">"].includes(s[0])), i.push(s);
            return {
                selector: i.join(","),
                selectors: i,
                isContextSelector: e
    ...
    function Zs(t, e = document, i) {
        var s;
        const n = Js(t);
        if (!n.isContextSelector) return n.selector ? Xi(e, i, n.selector) : t;
        t = "";
        const o = n.selectors.length === 1;
        for (let r of n.selectors) {
            let a, l = e;
            if (r[0] === "!" && ([a, r] = Ks(r), l = (s = e.parentElement) == null ? void 0 : s.closest(a), !r && o) || l && r[0] === "-" && ([a, r] = Ks(r), l = l.previousElementSibling, l = T(l, a) ? l : null, !r && o)) return l;
            if (l) {
                if (o) return r[0] === "~" || r[0] === "+" ? (r = `:scope > :nth-child(${yt(l)+1}) ${r}`, l = l.parentElement) : r[0] === ">" && (r = `:scope ${r}`), Xi(l, i, r);
                t += `${t?",":""}${mr(l)} ${r}`
            }
        }
        return Te(e) || (e = e.ownerDocument), Xi(e, i, t)
    }
    ...
    function z(...t) {
        const [e, i, s, n, o = !1, r] = Ki(t), a = w(e, i, s, l => {
            const c = !r || r(l);
            c && (a(), n(l, c))
        }, o);
        return a
    ...
    function m(t, e, i) {
        return Zi(t).every(s => s.dispatchEvent(pe(e, !0, !0, i)))
    }
    ...
    function Ki(t) {
        return t[0] = Zi(t[0]), H(t[1]) && (t[1] = t[1].split(" ")), ot(t[2]) && t.splice(2, 0, !1), t
    }
    ...
    function yr(t, e, i = 400, s = "linear") {
        return i = Math.round(i), Promise.all(E(t).map(n => new Promise((o, r) => {
            ...
            const a = setTimeout(() => m(n, ts), i);
            z(n, [ts, es], ({
                type: c
            }) => {
                clearTimeout(a), _(n, Qi), St(n, l), c === es ? r() : o(n)
            }, {
                self: !0
            }), I(n, Qi);
            const l = {
    ...
    function vt(t, e) {
        return X(e) ? x(t).innerHTML : j(nn(t), e)
    }
    const Sr = mi("prepend"),
        j = mi("append"),
        pi = mi("before"),
    ...
    function Le(t, e) {
        for (e = q(pi(t, e)); e.firstElementChild;) e = e.firstElementChild;
        return j(e, t), e
    }

    function is(t, e) {
        return E(E(t).map(i => i.hasChildNodes() ? Le(oe(i.childNodes), e) : j(i, e)))
    }
    ...
    function Mt(t, e) {
        if (re(t))
            for (e(t), t = t.firstElementChild; t;) Mt(t, e), t = t.nextElementSibling
    }

    function x(t, e) {
        return rn(t) ? q(It(t)) : Gi(t, e)
    }
    ...
    function g(t) {
        const e = re(t) ? q(t).getBoundingClientRect() : {
            height: tt(t),
            width: vi(t),
            top: 0,
            left: 0
    ...
    function an(t) {
        ...
        return (i, s) => {
            if (X(s)) {
                ...
                return i = q(i), s = h(i, t), s = s === "auto" ? i[`offset${e}`] : S(s) || 0, s - ge(i, t)
    ...
    function Ar() {
        return Re || (me || (me = x("<div>"), h(me, {
            height: "100vh",
            position: "fixed"
        }), w(window, "resize", () => Re = null)), j(document.body, me), Re = me.clientHeight, Q(me), Re)
    }
    const Dt = {
            read: Or,
            write: Mr,
    ...
    function Or(t) {
        return wi.push(t), os(), t
    }

    function Mr(t) {
        return xi.push(t), os(), t
    }
    ...
    function ln() {
        hn(wi), hn(xi.splice(0)), ns = !1, (wi.length || xi.length) && os()
    }

    function os() {
        ns || (ns = !0, queueMicrotask(ln))
    }
    ...
    function bn(t, {
        ...
        const i = W(t) ? Gt(t, !1, ["hidden"]) : [];
        return i.reduce((r, a, l) => {
            const {
                scrollTop: c,
                scrollHeight: u,
                offsetHeight: d
            } = a, f = at(a), p = u - f.height, {
                height: b,
                top: y
            } = i[l - 1] ? at(i[l - 1]) : C(t);
        ...
        function s(r, a, l, c) {
            return new Promise(u => {
                ...
                (function Ct() {
                    ...
                    let bt = 0;
                    i[0] === r && d + a < c && (bt = C(l).top + (b ? 0 : r.scrollTop) - y - g(fs(l)).height), h(r, "scrollBehavior") !== "auto" && h(r, "scrollBehavior", "auto"), r.scrollTop = d + (a + bt) * zt, h(r, "scrollBehavior", ""), zt === 1 && (P === bt || !it--) ? u() : (P = bt, requestAnimationFrame(Ct))
                })()
            })
        }
    ...
    function at(t) {
        ...
        const {
            body: o,
            documentElement: r
        } = e.document, a = s ? i === r || i.clientHeight < o.clientHeight ? i : o : t;
        for (let [l, c, u, d] of [
                ["width", "x", "left", "right"],
                ["height", "y", "top", "bottom"]
            ]) {
            const f = n[l] % 1;
            n[u] += S(h(a, `border-${u}-width`)), n[l] = n[c] = a[`client${Ht(l)}`] - (f ? f < .5 ? -f : 1 - f : 0), n[d] = n[l] + n[u]
        }
        return n
    }
    ...
    function fs(t) {
        ...
        for (const n of s ? [0, s] : [0]) {
            let o;
            for (const r of Lt(t).document.elementsFromPoint(e + i / 2, n)) !r.contains(t) && !$(r, "uk-togglable-leave") && (ps(r, "fixed") && wn(de(t).reverse().find(a => !a.contains(r) && !ps(a, "static"))) < wn(r) || ps(r, "sticky") && (!t || O(r).contains(t))) && (!o || g(o).height < g(r).height) && (o = r);
            if (o) return o
        }
    }
    ...
    function yn(t, e, i) {
        ...
        for (const [r, [a, , l, c]] of Object.entries(lt)) {
            const u = s.target[r] === s.element[r] ? at(e[r]) : C(e[r]);
            o = ms(o, u[l] - o[l] + kn(s.target[r], c, u[a]) - kn(s.element[r], c, o[a]) + +n[r], r)
        }
        return o
    }
    ...
    function Lr(t, e, i, s, n) {
        ...
        return i && (o[lt[n][2]] += i, o[lt[n][3]] -= i), s && (o = In(o, C(J(s) ? s[n] : s))), o
    }
    ...
    function Rr(t, e, i) {
        return $n(t, e, { ...i,
            attach: {
                element: i.attach.element.map(Cn).reverse(),
                target: i.attach.target.map(Cn).reverse()
            },
    ...
    var Yr = {
        ...
        connected() {
            this.$el.role = this.role, this.date = S(Date.parse(this.$props.date)), this.started = this.end = !1, this.start()
        },
        disconnected() {
            this.stop()
        },
    ...
    V.events = V.watch = V.observe = V.created = V.beforeConnect = V.connected = V.beforeDisconnect = V.disconnected = V.destroy = vs, V.args = function(t, e) {
        ...
        return i ? Tn(t, e, i) : e ? t ? function(s) {
            return Tn(t, e, s)
        } : e : t
    };
    ...
    function Ue(t, e, i) {
        ...
        if (ot(e) && (e = e.options), e.extends && (t = Ue(t, e.extends, i)), e.mixins)
            for (const o of e.mixins) t = Ue(t, o, i);
    ...
    function bs(t, e) {
        return t === Boolean ? Ri(e) : t === Number ? $t(e) : t === "list" ? Kr(e) : t === Object && H(e) ? ve(e) : t ? t(e) : e
    }
    const Jr = /,(?![^(]*\))/;

    function Kr(t) {
        return J(t) ? t : H(t) ? t.split(Jr).map(e => mt(e) ? $t(e) : Ri(e.trim())) : [t]
    }
    ...
    function Ve(t, e = "update") {
        t._connected && t._updates.length && (t._updateCount || (t._updateCount = 0, requestAnimationFrame(() => t._updateCount = 0)), t._queued || (t._queued = new Set, Dt.read(() => {
            t._connected && ta(t, t._queued), t._queued = null
        })), t._updateCount++ < 20 && t._queued.add(e.type || e))
    }
    ...
    function ta(t, e) {
        for (const {
            ...
            let o;
            i && (o = i.call(t, t._data, e), o && Ce(o) && ft(t._data, o)), s && o !== !1 && Dt.write(() => {
    ...
    var _n = {
        ...
        update: {
            ...
            write({
                ...
                for (const e of t)
                    for (const i of e) L(i, this.margin, t[0] !== e), L(i, this.firstColumn, e[U ? e.length - 1 : 0] === i)
            },
            events: ["resize"]
        }
    };
    ...
    function An(t, e, i, s = 0) {
        const n = Ss(e, !0),
            ...
            c = l(async () => {
                I(e, ys), await (s ? Promise.all(Mn(e).map(async (d, f) => (await Is(f * s), M.start(d, r, i / 2, "ease")))) : M.start(e, r, i / 2, "ease")), _(e, ys)
            }),
            u = l(async () => {
                const d = tt(e);
                I(e, ks), t(), h(s ? N(e) : e, r), tt(e, d), await Is(), tt(e, "");
                const f = tt(e);
                ...
                if (s) {
                    ...
                    h(N(e), r), p = y.map(async (P, it) => {
                        await Is(it * s), await M.start(P, o, i / 2, "ease"), a() && St(P, o)
                    }), b += y.length * s
                }
                if (!s || d !== f) {
                    const y = {
                ...
                await Promise.all(p), _(e, ks), a() && (St(e, {
                    height: "",
                    alignContent: "",
                    ...o
                }), delete e.dataset.transition)
            });
        return $(e, ys) ? On(e).then(u) : $(e, ks) ? On(e).then(c).then(u) : c().then(u)
    }

    function Ss(t, e) {
        return e && (t.dataset.transition = 1 + Ss(t)), $t(t.dataset.transition) || 0
    }
    ...
    async function sa(t, e, i) {
        ...
        const n = s.map(p => Dn(p, !0)),
            o = { ...h(e, ["height", "padding"]),
                display: "block"
            },
            r = s.concat(e);
        await Promise.all(r.map(M.cancel)), h(r, "transitionProperty", "none"), await t(), s = s.concat(N(e).filter(p => !v(s, p))), await Promise.resolve(), h(r, "transitionProperty", "");
        const a = k(e, "style"),
    ...
    function na(t, e, i) {
        const s = e.map((o, r) => O(o) && r in i ? i[r] ? W(o) ? Bn(o) : {
                opacity: 0
            } : {
                opacity: W(o) ? 1 : 0
            } : !1),
    ...
    function aa(t, e, i) {
        for (const o of i) h(o, "display", Object.values(t.filter).every(r => !r || T(o, r)) ? "" : "none");
        const [s, n] = t.sort;
        if (s) {
            const o = ha(i, s, n);
            Ae(o, i) || j(e, o)
    ...
    var ua = {
        ...
        connected() {
            this.loading !== "lazy" ? this.load() : Cs(this.$el) && (this.$el.loading = "lazy", Es(this.$el))
        },
        disconnected() {
        ...
        observe: be({
            ...
            target: ({
                $el: t,
                $props: e
            }) => e.target ? [t, ...ze(e.target, t)] : t
        }),
        methods: {
            load() {
                if (this.img) return this.img;
                const t = Cs(this.$el) ? this.$el : fa(this.$el, this.dataSrc, this.sources);
                return Oe(t, "loading"), Es(this.$el, t.currentSrc), this.img = t
            }
        }
    };
    ...
    function Es(t, e) {
        ...
        } else e && !v(t.style.backgroundImage, e) && (h(t, "backgroundImage", `url(${Ji(e)})`), m(t, pe("load", !1)))
    }
    ...
    function fa(t, e, i) {
        const s = new Image;
        return Wn(s, i), Ln(t, s), s.onload = () => Es(t, s.currentSrc), s.src = e, s
    }
    ...
    function jn(t) {
        const e = w(t, "touchstart", n => {
            if (n.targetTouches.length !== 1 || T(n.target, 'input[type="range"')) return;
            let o = kt(n).y;
    ...
    var Xe = {
        ...
        Rn = {
            ...
            connected() {
                this.pos = this.$props.pos.split("-").concat("center").slice(0, 2), [this.dir, this.align] = this.pos, this.axis = v(["top", "bottom"], this.dir) ? "y" : "x"
            },
            methods: {
                positionAt(t, e, i) {
    ...
    var Jt = {
        ...
        methods: {
                    ...
                    return await Promise.all(E(t).map(s => {
                        ...
                        const a = () => {
                            ...
                            if (_(s, r), m(s, n ? "shown" : "hidden", [this]), n) {
                                const c = Ei(s);
                                (l = D("[autofocus]", s).find(W)) == null || l.focus(), c()
                            }
                        };
            ...
            isToggled(t = this.$el) {
                return t = q(t), $(t, this.clsEnter) ? !0 : $(t, this.clsLeave) ? !1 : this.cls ? $(t, this.cls.split(" ")[0]) : W(t)
            },
            _toggle(t, e) {
                if (!t) return;
                e = !!e;
                let i;
                this.cls ? (i = v(this.cls, " ") || e !== $(t, this.cls), i && L(t, this.cls, v(this.cls, " ") ? void 0 : e)) : (i = e === t.hidden, i && (t.hidden = !e)), i && m(t, "toggled", [e, this])
            }
        }
    };
    ...
    async function ma(t, e, {
        ...
        const [l = "reveal", c = "top"] = ((a = i[0]) == null ? void 0 : a.split("-")) || [], u = [
            ["left", "right"],
            ["top", "bottom"]
        ], d = u[v(u[0], c) ? 0 : 1], f = d[1] === c, b = ["width", "height"][u.indexOf(d)], y = `margin-${d[0]}`, P = `margin-${c}`;
        let it = g(t)[b];
        const Ct = M.inProgress(t);
        ...
        f && (h(t, y, se - it + Us), rr[y] = e ? Us : se + Us), !f ^ l === "reveal" && (h(Wi, y, -se + it), M.start(Wi, {
            [y]: e ? 0 : -se
        }, s, o));
        try {
            await M.start(t, rr, s, o)
        } finally {
            h(t, zt), We(Wi.firstChild), e || r(t, !1)
        }
    }
    ...
    var Ps = {
        ...
        events: [{
            ...
            handler(t) {
                ...
                !i && s && fe(e) && !this.$el.contains(x(s)) ? this.hide() : T(e, this.selClose) && (Et(t), this.hide())
            }
        }, {
            name: "toggle",
            self: !0,
            ...
            self: !0,
            handler() {
                Be(this.$el) || (this.$el.tabIndex = -1), T(this.$el, ":focus-within") || this.$el.focus()
            }
        }, {
            name: "hidden",
            self: !0,
            handler() {
                ...
                nt.some(e => e.clsPage === this.clsPage) || (_(document.documentElement, this.clsPage), queueMicrotask(() => {
                    if (Be(t)) {
                        const e = Ei(t);
                        t.focus(), e()
                    }
                })), Un(t, !1), this.target = null
            }
        }],
        methods: {
            toggle() {
            ...
            show() {
                return this.container && O(this.$el) !== this.container ? (j(this.container, this.$el), new Promise(t => requestAnimationFrame(() => this.show().then(t)))) : this.toggleElement(this.$el, !0, qn)
            },
            hide() {
    ...
    function xa(t) {
        return w(document, ut, ({
            target: e
        }) => {
            Wt(nt) !== t || t.overlay && !t.$el.contains(e) || !t.panel || t.panel.contains(e) || z(document, `${_t} ${hi} scroll`, ({
                defaultPrevented: i,
                type: s,
                target: n
            }) => {
    ...
    function ya(t, e, i, {
        ...
        return {
            ...
            translate(d) {
                this.reset();
                const f = r(d, i);
                h(e, f[1]), h(t, f[0]), Kt(e, "itemtranslatein", {
                    percent: d,
                    dir: i
            ...
            methods: {
                startAutoplay() {
                    this.stopAutoplay(), this.interval = setInterval(() => {
                        this.stack.length || !W(this.$el) || this.draggable && T(this.$el, ":focus-within") && !T(this.$el, ":focus") || this.pauseOnHover && T(this.$el, ":hover") || this.show("next")
        ...
        methods: {
            ...
            move(t) {
                ...
                let {
                    slides: i,
                    prevIndex: s
                } = this, n = Math.abs(e), o = this.getIndex(s + this.dir), r = Xn.call(this, s, o);
                for (; o !== s && n > r;) this.drag -= r * this.dir, s = o, n -= r, o = this.getIndex(s + this.dir), r = Xn.call(this, s, o);
                this.percent = n / r;
                const a = i[s],
                    l = i[o],
                    c = this.index !== o,
                    u = s === o;
                let d;
                for (const f of [this.index, this.prevIndex]) v([o, s], f) || (m(i[f], "itemhidden", [this]), u && (d = !0, this.prevIndex = s));
                (this.index === s && this.prevIndex !== s || d) && m(i[this.index], "itemshown", [this]), c && (this.prevIndex = s, this.index = o, u || (m(a, "beforeitemhide", [this]), m(a, "itemhide", [this])), m(l, "beforeitemshow", [this]), m(l, "itemshow", [this])), this._transitioner = this._translate(Math.abs(this.percent), a, !u && l)
            },
            end() {
                if (Vt(document, As, this.move, Ti), Vt(document, Gn, this.end, Yn), this.dragging)
                    if (setTimeout(w(this.list, "click", t => t.preventDefault(), Ti)), this.dragging = null, this.index === this.prevIndex) this.percent = 1 - this.percent, this.dir *= -1, this._show(!1, this.index, !0), this._transitioner = null;
                    else {
                        const t = (U ? this.dir * (U ? 1 : -1) : this.dir) < 0 == this.prevPos > this.pos;
                        this.index = t ? this.index : this.prevIndex, t && (m(this.slides[this.prevIndex], "itemhidden", [this]), m(this.slides[this.index], "itemshown", [this]), this.percent = 1 - this.percent), this.show(this.dir > 0 && !t || this.dir < 0 && t ? "next" : "previous", !0)
                    }
                h(this.list, {
                    userSelect: ""
    ...
    function Ta(t, e) {
        for (const {
                ...
                handler: s,
                immediate: n = !0
            } of t._watches)(t._initial && n || gt(e, i) && !Ae(e[i], t[i])) && s.call(t, t[i], e[i]);
        t._initial = !1
    }
    ...
    function _a(t) {
        ...
        }), t._computedObserver = as(t.$el, () => Ve(t, "computed"), Kn), t._disconnect.push(() => {
    ...
    function Aa(t) {
        for (const e of t.$options.events || [])
            if (gt(e, "handler")) to(t, e);
            else
                for (const i in e) to(t, {
                    name: i,
                    handler: e[i]
                })
    }
    ...
    function eo(t) {
        ...
        for (const a in s) {
            const l = Ft(a);
            let c = Z(n, l);
            X(c) || (c = s[a] === Boolean && c === "" ? !0 : bs(s[a], c), !(l === "target" && wt(c, "_")) && (e[a] = c))
        }
        const r = ve(Z(n, o), i);
        for (const a in r) {
            const l = Ee(a);
            X(s[l]) || (e[l] = bs(s[l], r[a]))
        }
        return e
    }
    const Na = ct((t, e) => {
    ...
    function za(t) {
        ...
        const {
            attributes: r,
            filter: a
        } = Na(s, n), l = new MutationObserver(c => {
            const u = eo(e);
            c.some(({
                attributeName: d
            }) => {
    ...
    function Os(t) {
        t._connected || (Ba(t), we(t, "beforeConnect"), t._connected = !0, t._disconnect = [], Aa(t), Zr(t), Ca(t), Oa(t), za(t), _a(t), we(t, "connected"), Ve(t))
    }
    ...
    function io(t, e = {}) {
        e.data = Wa(e, t.constructor.options), t.$options = Ue(t.constructor.options, e, t), t.$props = {}, t._uid = Fa++, Ha(t), La(t), Pa(t), we(t, "created"), e.el && t.$mount(e.el)
    }
    ...
    function Wa({
        ...
        J(t) && (t = t.slice(0, e.length).reduce((s, n, o) => (Ce(n) ? ft(s, n) : s[e[o]] = n, s), {}));
        for (const s in t) X(t[s]) ? delete t[s] : i[s] && (t[s] = bs(i[s], t[s]));
        return t
    }
    const ht = function(t) {
        io(this, t)
    };
    ht.util = Ur, ht.options = {}, ht.version = "3.23.13";
    const ja = "uk-",
        Zt = "__uikit__",
        xe = {};
    ...
    function Ra(t, e) {
        t[Zt] || (t[Zt] = {}), t[Zt][e.$options.name] = e
    }

    function qa(t, e) {
        var i;
        (i = t[Zt]) == null || delete i[e.$options.name], ni(t[Zt]) && delete t[Zt]
    }

    function Ua(t) {
        t.component = so, t.getComponents = Ze, t.getComponent = Pi, t.update = no, t.use = function(i) {
    ...
    function no(t, e) {
        t = t ? q(t) : document.body;
        for (const i of de(t).reverse()) oo(i, e);
        Mt(t, i => oo(i, e))
    }
            ...
            navItems(t) {
                for (const e of t) {
                    ...
                    if (mt(i)) {
                        const r = $t(i),
                            a = this.slides[r];
                        a && (a.id || (a.id = Qt(this, a)), o = a.id), n = this.t("slideX", S(i) + 1), s.role = "tab"
                    } else this.list && (this.list.id || (this.list.id = Qt(this, this.list)), o = this.list.id), n = this.t(i);
        ...
        methods: {
            updateNav() {
                ...
                for (const e of this.navItems) {
                    ...
                    if (mt(i)) {
                        const o = $t(i) === t;
                        L(e, this.clsActive, o), L(s, "uk-disabled", !!this.parallax), s.ariaSelected = o, s.tabIndex = o && !this.parallax ? null : -1, o && s && T(O(e), ":focus-within") && s.focus()
    ...
    var ro = {
        ...
        methods: {
            async show(t, e = !1) {
                ...
                a && m(a, "itemhide", [this]), m(c, "itemshow", [this]), await this._show(a, c, e), a && m(a, "itemhidden", [this]), m(c, "itemshown", [this]), s.shift(), this._transitioner = null, s.length && requestAnimationFrame(() => s.length && this.show(s.shift(), !0))
            },
        ...
        co = {
            ...
            created() {
                ...
                const e = x(this.selList, t),
                    i = this.$props.nav;
                Q(D(this.selNav, t).filter(o => !T(o, `.uk-${i}`)));
                for (const [o, r] of this.items.entries()) j(e, "<div>"), i === "thumbnav" && Le(Qa(r, this.videoAutoplay), j(x(this.selNav, t), `<li uk-lightbox-item="${o}"><a href></a></li>`));
                this.slidenav || Q(D(".uk-lightbox-slidenav", t)), this.counter || Q(x(this.selCounter, t)), I(e, this.clsFit);
            ...
            events: [{
                ...
                handler({
                    ...
                    let e = -1;
                    t === B.LEFT ? e = "previous" : t === B.RIGHT ? e = "next" : t === B.HOME ? e = 0 : t === B.END && (e = "last"), ~e && this.show(e)
                }
            }, {
                name: "beforeitemshow",
                handler(t) {
            ...
            methods: {
                ...
                showControls() {
                    clearTimeout(this.controlsTimer), this.controlsTimer = this.delayControls && setTimeout(this.hideControls, this.delayControls), I(this.$el, "uk-active", "uk-transition-active")
                },
                hideControls() {
    ...
    var el = {
        ...
        events: {
            ...
            handler(t) {
                t.defaultPrevented || (t.preventDefault(), T(t.current, tl) || this.show(t.current))
            }
        },
        methods: {
            show(t) {
    ...
    var nl = {
        ...
        created() {
            const t = `${this.clsContainer}-${this.pos}`,
                ...
                i = x(`.${t}[${e}]`, this.container) || j(this.container, `<div class="${this.clsContainer} ${t}" ${e}></div>`);
            this.$mount(j(i, `<div class="${this.clsMsg}${this.status?` ${this.clsMsg}-${this.status}`:""}" role="alert"> <a href class="${this.clsClose}" data-uk-close></a> <div>${this.message}</div> </div>`))
        },
        async connected() {
    ...
    function rl(t, e) {
        if (H(t)) {
            if (wt(t, "@")) t = S(h(e, `--uk-breakpoint-${t.slice(1)}`));
    ...
    function go(t) {
        return W(t) ? Math.ceil(Math.max(0, ...D("[stroke]", t).map(e => {
            var i;
    ...
    var vo = {
        mixins: [_i],
        props: ko(mo(Ai), "list"),
        data: ko(mo(Ai), void 0),
        computed: {
            props(t, e) {
                const i = {};
                for (const n in t) n in Ai && !X(t[n]) && (i[n] = t[n].slice());
                const s = {};
                for (const n in i) s[n] = Ai[n](n, e, i[n], i);
                return s
            }
        },
        events: {
    ...
    function Oi(t, e, i) {
        ...
        return t === "x" || t === "y" ? (t = `translate${Ht(t)}`, n = o => S(S(o).toFixed(s === "px" ? 0 : 6))) : t === "scale" && (s = "", n = o => {
            var r;
            return Di([o]) ? G(o, "width", e, !0) / e[`offset${(r=o.endsWith)!=null&&r.call(o,"vh")?"Height":"Width"}`] : S(o)
    ...
    function ul(t) {
        ...
        return e && (i.src = e, !i.naturalWidth && !$o[e]) ? (z(i, "error load", () => {
            Mi[e] = Bs(i), m(t, pe("load", !1))
        }), $o[e] = !0, Bs(i)) : Mi[e] = Bs(i)
    }
    ...
    var Eo = {
        ...
        update: {
            ...
            write({
                ...
                const [e, i] = t, s = this.getValidIndex(e + Math.ceil(i)), n = this.slides[e], o = this.slides[s], {
                    triggerShow: r,
                    triggerShown: a,
                    triggerHide: l,
                    triggerHidden: c
                ...
                if (~this.prevIndex)
                    for (const d of new Set([this.index, this.prevIndex])) v([s, e], d) || (l(this.slides[d]), c(this.slides[d]));
    ...
    function gl(t, e, i, {
        ...
        return {
            ...
            translate(u) {
                ...
                h(o, "transform", R(K(-a + (d - d * u), -ke(o), g(o).width) * (U ? -1 : 1), "px"));
                ...
                for (const y of N(o)) {
                    const P = v(f, y),
                        it = y === p,
                        Ct = y === b,
                        zt = it || !Ct && (P || i * (U ? -1 : 1) === -1 ^ Bi(y, o) > Bi(t || e));
                    Kt(y, `itemtranslate${zt?"in":"out"}`, {
                        dir: i,
                        percent: Ct ? 1 - u : it ? u : P ? 1 : 0
                    })
                }
            },
            percent() {
    ...
    function Bi(t, e) {
        return t && (ss(t).left + (U ? g(t).width - g(e).width : 0)) * (U ? -1 : 1) || 0
    }
    ...
    var vl = {
        ...
        computed: {
            ...
            sets({
                ...
                for (let n = 0; n < this.length; n++) {
                    ...
                    e + o > s && (e = 0), this.center ? e < s / 2 && e + o + g(this.slides[rt(n + 1, this.slides)]).width / 2 > s / 2 && (i.push(n), e = s / 2 - o / 2) : e === 0 && i.push(Math.min(n, this.maxIndex)), e += o
                }
        ...
        methods: {
            reorder() {
                ...
                if (this.slides.forEach((n, o) => h(n, "order", this.dir > 0 && o < t ? 1 : this.dir < 0 && o >= this.index ? -1 : "")), !this.center || !this.length) return;
            ...
            updateActiveClasses(t = this.index) {
                ...
                for (const s of this.slides) {
                    ...
                    for (const o of D(ue, s)) gt(o, "_tabindex") || (o._tabindex = o.tabIndex), o.tabIndex = n ? o._tabindex : -1
                }
            },
            getValidIndex(t = this.index, e = this.prevIndex) {
            ...
            getAdjacentSlides() {
                const {
                    width: t
                } = g(this.list), e = -t, i = t * 2, s = g(this.slides[this.index]).width, n = this.center ? t / 2 - s / 2 : 0, o = new Set;
                for (const r of [-1, 1]) {
                    let a = n + (r > 0 ? s : 0),
                        l = 0;
                    do {
        ...
        $l = {
            ...
            methods: {
                ...
                start(t) {
                    ...
                    }), I(this.drag, this.clsDrag, this.clsCustom), I(this.placeholder, this.clsPlaceholder), I(this.items, this.clsItem), I(document.documentElement, this.clsDragState), m(this.$el, "start", [this, this.placeholder]), yl(this.pos), this.move(t)
                },
                move: Tl(function(t) {
                    ft(this.pos, kt(t)), !this.drag && (Math.abs(this.pos.x - this.origin.x) > this.threshold || Math.abs(this.pos.y - this.origin.y) > this.threshold) && this.start(t), this.$emit("move")
                }),
                end() {
                    if (Vt(document, Me, this.move), Vt(document, _t, this.end), !this.drag) return;
                    kl();
                    const t = this.getSortable(this.placeholder);
                    this === t ? this.origin.index !== yt(this.placeholder) && m(this.$el, "moved", [this, this.placeholder]) : (m(t.$el, "added", [t, this.placeholder]), m(this.$el, "removed", [this, this.placeholder])), m(this.$el, "stop", [this, this.placeholder]), Q(this.drag), this.drag = null;
                    for (const {
                            clsPlaceholder: e,
                            clsItem: i
                        } of this.touched)
                ...
                insert(t, e) {
                    I(this.items, this.clsItem), e && e.previousElementSibling !== t ? this.animate(() => pi(e, t)) : !e && this.target.lastElementChild !== t && this.animate(() => j(this.target, t))
                },
                remove(t) {
    ...
    function yl(t) {
        ...
        Do = setInterval(() => {
            ...
            e = Date.now(), Gt(document.elementFromPoint(i, t.y)).reverse().some(o => {
                let {
                    scrollTop: r,
                    scrollHeight: a
                } = o;
    ...
    function Sl(t, e) {
        let i;
        if (F(e, "li", "tr")) {
            i = x("<div>"), j(i, e.cloneNode(!0).children);
    ...
    function El(t, e, i, s, n, o) {
        ...
        const r = g(e);
        if (!o) return Cl(t, i) || n < r.top + r.height / 2 ? e : e.nextElementSibling;
        const a = g(i),
    ...
    var Pl = {
        ...
        methods: {
            ...
            async hide() {
                var t;
                T(this.$el, "input:focus") || (clearTimeout(this.showTimer), this.isToggled(this.tooltip || null) && await this.toggleElement(this.tooltip, !1, !1), (t = this.reset) == null || t.call(this), Q(this.tooltip), this.tooltip = null)
            },
            async _show(t, e) {
                this.tooltip = j(this.container, `<div id="${e}" class="uk-${this.$options.name}" role="tooltip"> <div class="uk-${this.$options.name}-inner">${t}</div> </div>`), w(this.tooltip, "toggled", (i, s) => {
                    if (!s) return;
    ...
    var Ml = {
        ...
        events: {
            ...
            dragover(t) {
                Ni(t), I(this.$el, this.clsDragover)
            },
            dragleave(t) {
                Ni(t), _(this.$el, this.clsDragover)
            }
        },
        methods: {
            async upload(t) {
                if (t = oe(t), !t.length) return;
                m(this.$el, "upload", [t]);
                for (const s of t) {
    ...
    function Hl(t) {
        ...
        for (const {
            ...
            const r = o && Ho(o);
            r && (Pt(n, o) ? Ke(r, n) : (e = Pi(n, r)) == null || e.$destroy())
        }
    }
    ...
    var Wo = {
        ...
        beforeConnect() {
            this.autoplay === "inview" && !Pt(this.$el, "preload") && (this.$el.preload = "none"), F(this.$el, "iframe") && !Pt(this.$el, "allow") && (this.$el.allow = "autoplay"), this.autoplay === "hover" && (F(this.$el, "video") ? this.$el.tabIndex = 0 : this.autoplay = !0), this.automute && pn(this.$el)
        },
        events: [{
            name: `${At} focusin`,
            filter: ({
            ...
            handler(t) {
                !pt(t) || !Ul(this.$el) ? ls(this.$el) : $i(this.$el)
            }
        }, {
            name: `${Ut} focusout`,
            filter: ({
        ...
        observe: [be({
            ...
            handler([{
                ...
                document.fullscreenElement || (t ? this.autoplay && ls(this.$el) : $i(this.$el))
            },
            args: {
                intersecting: !1
            },
    ...
    var Vl = {
        ...
        update: {
            read() {
                ...
                const {
                    $el: t,
                    width: e = t.clientWidth,
                    height: i = t.clientHeight
                } = this, s = jo(t) || O(t), n = Vi.cover({
                    width: e,
                    height: i
                }, {
                    width: s.offsetWidth,
    ...
    var Ro = {
        ...
        connected() {
            I(this.$el, "uk-drop", this.clsDrop), this.toggle && !this.targetEl && (this.targetEl = Gl(this)), k(this.targetEl, "aria-expanded", !1), this._style = oi(this.$el.style, ["width", "height"])
        },
        disconnected() {
        ...
        methods: {
            show(t = this.targetEl, e = !0) {
                if (this.isToggled() && t && this.targetEl && t !== this.targetEl && this.hide(!1, !1), this.targetEl = t, this.clearTimers(), !this.isActive()) {
                    ...
                    this.container && O(this.$el) !== this.container && j(this.container, this.$el), this.showTimer = setTimeout(() => this.toggleElement(this.$el, !0), e && this.delayShow || 0)
                }
            },
            hide(t = !0, e = !0) {
            ...
            position() {
                ...
                for (const [o, [r, a]] of s) this.axis !== r && v([r, !0], this.stretch) && h(this.$el, {
                    [a]: Math.min(C(this.boundary[o])[a], e[o][a] - 2 * i),
                    [`overflow-${r}`]: "auto"
                });
                const n = e[0].width - 2 * i;
                this.$el.hidden = !1, h(this.$el, "maxWidth", ""), this.$el.offsetWidth > n && I(this.$el, "uk-drop-stack"), h(this.$el, "maxWidth", n), this.positionAt(this.$el, this.target, this.boundary);
                for (const [o, [r, a, l, c]] of s)
                    if (this.axis === r && v([r, !0], this.stretch)) {
                        const u = Math.abs(this.getPositionOffset()),
                            ...
                            f = C(this.$el);
                        h(this.$el, {
                            [a]: (d[l] > f[l] ? d[this.inset ? c : l] - Math.max(C(this.boundary[o])[l], e[o][l] + i) : Math.min(C(this.boundary[o])[c], e[o][c] - i) - d[this.inset ? l : c]) - u,
                            [`overflow-${r}`]: "auto"
    ...
    function Gl(t) {
        const {
            $el: e
        } = t.$create("toggle", et(t.toggle, t.$el), {
            target: t.$el,
            mode: t.mode
        });
    ...
    function Xl(t) {
        const e = () => t.$emit(),
            i = [rs(e), qe(Xt(t.$el).concat(t.target), e)];
    ...
    function Zl(t) {
        return w(document, ut, ({
            ...
            t.$el.contains(e) || z(document, `${_t} ${hi} scroll`, ({
                defaultPrevented: i,
                type: s,
                target: n
            }) => {
    ...
    var Uo = {
        ...
        events: [{
            ...
            handler(t) {
                ...
                if (s === B.DOWN)
                    if ((n == null ? void 0 : n.targetEl) === i) t.preventDefault(), (e = x(ue, n.$el)) == null || e.focus();
                    else {
            ...
            handler(t) {
                ...
                if (s === B.HOME ? r = 0 : s === B.END ? r = "last" : s === B.UP ? r = "previous" : s === B.DOWN ? r = "next" : s === B.ESC && ((e = o.targetEl) == null || e.focus()), ~r) {
                    t.preventDefault();
                    const a = D(ue, i);
                    a[rt(r, a, xt(a, l => T(l, ":focus")))].focus();
                    return
                }
                Vo(t, this.items, o)
            }
            ...
            handler() {
                ...
                t && v(t.mode, "hover") && !this.dropdowns.some(e => T(e, ":hover")) && t.hide()
            }
        }, {
            name: "beforeshow",
            el: ({
            ...
            handler({
                ...
                const e = this.getDropdown(t),
                    i = () => {
                        const s = Math.max(...de(t, `.${this.clsDrop}`).concat(t).map(n => C(n).bottom));
                        C(this.dropbar, {
                            left: C(this.dropbar).left,
                            top: this.getDropbarOffset(e.getPositionOffset())
                        }), this.transitionTo(s - C(this.dropbar).top + S(h(t, "marginBottom")), t)
                    };
            ...
            handler(t) {
                const e = this.getActive();
                T(this.dropbar, ":hover") && e.$el === t.target && this.isDropbarDrop(e.$el) && v(e.mode, "hover") && e.isDelayedHide && !this.items.some(i => e.targetEl !== i && T(i, ":focus")) && t.preventDefault()
            }
        }, {
            name: "hide",
            el: ({
    ...
    function Vo(t, e, i) {
        ...
        let l = -1;
        a === B.HOME ? l = 0 : a === B.END ? l = "last" : a === B.LEFT ? l = "previous" : a === B.RIGHT ? l = "next" : a === B.TAB && ((s = i.targetEl) == null || s.focus(), (n = i.hide) == null || n.call(i, !1)), ~l && (t.preventDefault(), (o = i.hide) == null || o.call(i, !1), e[rt(l, e, e.indexOf(i.targetEl || r))].focus())
    }
    ...
    var th = {
            ...
            update() {
                ...
                const n = ci(e) ? "value" : "textContent",
                    o = e[n],
                    r = (t = i.files) != null && t[0] ? i.files[0].name : T(i, "select") && (s = D("option", i).filter(a => a.selected)[0]) ? s.textContent : i.value;
                o !== r && (e[n] = r)
            },
            events: [{
                name: "change",
        ...
        for (let a of t) {
            ...
            for (const c in a) {
                const {
                    offsetWidth: u,
                    offsetHeight: d
                } = a[c], f = i ? c : o.indexOf(Math.min(...o));
                Ns(s, f, a[c]), Ns(n, f, [(f - c) * u * (U ? -1 : 1), o[f] - r]), o[f] += d + e, l = Math.max(l, d)
            }
            r += l + e
        }
        return [s, n]
    ...
    var oh = {
        ...
        update: {
            read() {
                return {
                    rows: (this.row ? xs(this.elements) : [this.elements]).map(rh)
                }
            },
            write({
                rows: t
                ...
                for (const {
                        heights: e,
                        elements: i
                    } of t) i.forEach((s, n) => h(s, "minHeight", e[n]))
            },
            events: ["resize"]
        }
    };
    ...
    function ah(t) {
        ...
        W(t) || h(t, "display", "block", "important"), h(t, "minHeight", "");
    ...
    var lh = {
            ...
            update: {
                read() {
                    ...
                    if (t = `calc(${r?"100vh":`${o}px`}`, this.expand) {
                        ...
                        this.offsetBottom === !0 ? t += ` - ${g(this.$el.nextElementSibling).height}px` : mt(this.offsetBottom) ? t += ` - ${this.offsetBottom}vh` : this.offsetBottom && ne(this.offsetBottom, "px") ? t += ` - ${S(this.offsetBottom)}px` : H(this.offsetBottom) && (t += ` - ${g(et(this.offsetBottom,this.$el)).height}px`)
                    }
                    return t += `${e?` - ${e}px`:""})`, {
                        minHeight: t
                    }
        ...
        Th = '<svg width="18" height="10" viewBox="0 0 18 10"><polyline fill="none" stroke="#000" stroke-width="1.2" points="1 9 9 1 17 9"/></svg>',
        Xo = {
            args: "src",
            props: {
                width: Number,
            ...
            disconnected() {
                this.svg.then(t => {
                    this._connected || (Yi(this.$el) && (this.$el.hidden = !1), Q(t), this.svgEl = null)
                }), this.svg = null
            },
            methods: {
                async getSvg() {}
        ...
        Dh = {
            ...
            beforeConnect() {
                ...
                if (this.icon = t ? "search-toggle-icon" : $(this.$el, "uk-search-icon") && this.$el.closest(".uk-search-large") ? "search-large" : this.$el.closest(".uk-search-medium") ? "search-medium" : this.$props.icon, !Pt(this.$el, "aria-label"))
                    if (t) this.$el.ariaLabel = this.t("toggle");
                    else {
    ...
    function qh(t) {
        return t = Rh[t] || t, Fi[t] ? (Hi[t] || (Hi[t] = Ko(Fi[Uh(t)] || Fi[t])), Hi[t].cloneNode(!0)) : null
    }

    function Uh(t) {
        return U ? qi(qi(t, "left", "right"), "previous", "next") : t
    }
    var Vh = {
        props: {
            target: String,
        ...
        observe: [be({
            handler(t) {
                this.isIntersecting = t.reduce((e, {
                    isIntersecting: i
                }) => e + (i ? 1 : this.isIntersecting ? -1 : 0), this.isIntersecting), this.$emit()
            },
            target: ({
                target: t
            }) => t,
        ...
        update: {
            read() {
                ...
                for (const t of E(this.target)) {
                    let e = !this.selActive || T(t, this.selActive) ? Yh(t) : "";
    ...
    function Yh(t) {
        ...
        for (const l of [.25, .5, .75]) {
            ...
            for (const u of c) {
                if (t.contains(u) || !Gh(u) || u.closest('[class*="-leave"]') && c.some(f => u !== f && T(f, '[class*="-enter"]'))) continue;
    ...
    var Xh = {
            ...
            computed: {
                fill: ({
                    fill: t
                }, e) => t || h(e, "--uk-leader-fill-content")
            },
            connected() {
        ...
        Jh = {
            ...
            events: [{
                ...
                self: !0,
                handler() {
                    $(this.panel, "uk-margin-auto-vertical") ? I(this.$el, "uk-flex") : h(this.$el, "display", "block"), tt(this.$el)
                }
            }, {
                name: "hidden",
                self: !0,
    ...
    function Kh({
        ...
        t.dialog = function(i, s) {
            ...
            return e(({
                i18n: n
            }) => `<div class="uk-modal-body">${H(i)?i:vt(i)}</div> <div class="uk-modal-footer uk-text-right"> <button class="uk-button uk-button-primary uk-modal-close" type="button" autofocus>${n.ok}</button> </div>`, s)
        }, t.confirm = function(i, s) {
            return e(({
                i18n: n
            }) => `<form> <div class="uk-modal-body">${H(i)?i:vt(i)}</div> <div class="uk-modal-footer uk-text-right"> <button class="uk-button uk-button-default uk-modal-close" type="button">${n.cancel}</button> <button class="uk-button uk-button-primary" autofocus>${n.ok}</button> </div> </form>`, s, () => Promise.reject())
    ...
    var Qh = {
        ...
        events: [{
            ...
            async handler() {
                await tc(), this._transparent && (!Y || !this.dropContainer.contains(Y.$el)) && (I(this.navbarContainer, Fs), this._transparent = null)
            }
        }],
        methods: {
    ...
    var ec = {
        ...
        events: [{
            ...
            handler() {
                ...
                I(t, this.clsContainer, this.clsFlip), h(t, "touchAction", "pan-y pinch-zoom"), h(this.$el, "display", "block"), h(this.panel, "maxWidth", e.clientWidth), I(this.$el, this.clsOverlay), I(this.panel, this.clsSidebarAnimation, this.mode === "reveal" ? "" : this.clsMode), tt(t), I(t, this.clsContainerAnimation), this.clsContainerAnimation && ic()
            }
        }, {
            name: "hide",
            self: !0,
            ...
            self: !0,
            handler() {
                this.clsContainerAnimation && sc(), this.mode === "reveal" && $(O(this.panel), this.clsMode) && We(this.panel), _(this.panel, this.clsSidebarAnimation, this.clsMode), _(this.$el, this.clsOverlay), h(this.$el, "display", ""), h(this.panel, "maxWidth", ""), _(document.body, this.clsContainer, this.clsFlip)
            }
        }, {
    ...
    function Qo() {
        return x('meta[name="viewport"]', document.head) || j(document.head, '<meta name="viewport">')
    }
    var nc = {
            mixins: [st],
            props: {
    ...
    function lc(t) {
        ii.delete(t), ii.size || Vt(document, "click", tr)
    }

    function tr(t) {
        if (!t.defaultPrevented)
            for (const e of ii) e.$el.contains(t.target) && fe(e.$el) && (t.preventDefault(), window.location.href !== e.$el.href && window.history.pushState({}, "", e.$el.href), e.scrollTo(ui(e.$el)))
    }
    ...
    var hc = {
            ...
            methods: {
                toggle(t, e) {
                    ...
                    if (!n) return;
                    (s = n.off) == null || s.call(n), h(t, "opacity", !e && this.hidden ? 0 : ""), L(t, Hs, e), L(t, n.cls);
                    let o;
            ...
            computed: {
                links: {
                    get({
                        ...
                        return D(t, e).filter(ui)
                    },
                    observe: () => "*"
                },
                targets() {
                    return this.links.map(t => ui(t))
                },
                elements({
                    closest: t
                }) {
            ...
            update: [{
                read() {
                    ...
                    if (s >= r) a = e - 1;
                        ...
                        const l = this.offset + g(fs()).height + o.height * .1;
                        for (let c = 0; c < t.length && !(C(t[c]).top - o.top - l > 0); c++) a = +c
                    }
                    return {
                        active: a
                    }
                ...
                write({
                    ...
                    const {
                        elements: e
                    } = this, i = t !== !1 && !$(e[t], this.cls);
                    this.links.forEach(s => s.blur());
                    for (let s = 0; s < e.length; s++) L(e[s], this.cls, +s === t);
                    i && m(this.$el, "active", [t, e[t]])
                },
                events: ["scroll", "resize"]
            }]
        },
        uc = {
            ...
            connected() {
                this.start = er(this.start || this.top), this.end = er(this.end || this.bottom), this.placeholder = x("+ .uk-sticky-placeholder", this.$el) || x('<div class="uk-sticky-placeholder"></div>'), this.isFixed = !1, this.setActive(!1)
            },
            beforeDisconnect() {
                this.isFixed && (this.hide(), _(this.target, this.clsInactive)), Ws(this.$el), Q(this.placeholder), this.placeholder = null
            },
            observe: [ws(), Ye({
                ...
                target: ({
                    $el: t
                }) => [t, Li(t), document.scrollingElement],
                handler(t) {
                    this.$emit(this._data.resized && t.some(({
                        target: e
                    }) => e === Li(this.$el)) ? "update" : "resize"), this._data.resized = !0
                }
            })],
            events: [{
            ...
            update: [{
                read({
                    ...
                    if (this.inactive = !this.matchMedia || !W(this.$el) || !this.$el.offsetHeight, this.inactive) return;
                    const o = tt(window),
                    ...
                    a && (Rs(this.target), this.hide()), this.active || ({
                        height: t,
                        width: e
                    } = g(this.$el), i = h(this.$el, "margin")), a && this.show();
                    ...
                    const p = t + d + f,
                        ...
                        y = C(u).top - new DOMMatrix(h(u, "transform")).m42,
                        P = g(this.$el).height,
                        it = (this.start === !1 ? y : Ls(this.start, this.$el, y)) - d,
                        Ct = this.end === !1 ? r : Math.min(r, Ls(this.end, this.$el, y + t, !0) - P - d + b);
                    return s = !this.showOnUp && it + d === y && Ct === Math.min(r, Ls(!0, this.$el, 0, !0) - P - d + b) && h(Li(this.$el), "overflowY") !== "hidden", {
                        start: it,
                        end: Ct,
                        offset: d,
                        overflow: b,
                ...
                read({
                    ...
                    return {
                        ...
                        scroll: u,
                        prevScroll: t,
                        below: u > C(f).top + (l ? Math.min(a, r) : a),
                        offsetParentTop: C(f.offsetParent).top,
                ...
                write(t, e) {
                    ...
                    if ((d - s > 300 || n !== o) && (t.initScroll = r, t.initTimestamp = d), !(this.showOnUp && !this.isFixed && Math.abs(t.initScroll - r) <= 30 && Math.abs(a - r) <= 10))
                        ...
                        } else this.isFixed ? this.update() : this.animation && u ? (this.show(), Ot.in(this.$el, this.animation).catch(A)) : (Rs(this.target), this.show())
                },
            ...
            methods: {
                ...
                hide() {
                    ...
                    this.setActive(!1), _(this.$el, this.clsFixed, this.clsBelow), e ? h(this.$el, "top", t) : Ws(this.$el), this.placeholder.hidden = !0, this.isFixed = !1
                },
                update() {
                    let {
                        width: t,
                ...
                setActive(t) {
                    const e = this.active;
                    this.active = t, t ? (li(this.target, this.clsInactive, this.clsActive), e !== t && m(this.$el, "active")) : (li(this.target, this.clsActive, this.clsInactive), e !== t && (Rs(this.target), m(this.$el, "inactive")))
                }
            }
        };
    ...
    function Ls(t, e, i, s) {
        ...
        if (mt(t) || H(t) && t.match(/^-?\d/)) return i + G(t, "height", e, !0); {
            const n = t === !0 ? Li(e) : et(t, e);
            return C(n).bottom - (s && (n != null && n.contains(e)) ? S(h(n, "paddingBottom")) + S(h(n, "borderBottomWidth")) : 0)
        }
    }
    ...
    var sr = {
            ...
            events: [{
                ...
                handler(t) {
                    !T(t.current, qs) && (t.type === "click" || t.keyCode === B.SPACE) && (Et(t), this.show(t.current))
                }
            }, {
                name: "keydown",
                delegate: ({
                ...
                handler(t) {
                    ...
                    if (~n) {
                        t.preventDefault();
                        const o = this.toggles.filter(a => !T(a, qs)),
            ...
            update() {
                ...
                for (const e in this.toggles) {
                    ...
                    i.role = "tab", s && (i.id = Qt(this, i), s.id = Qt(this, s), i.ariaControls = s.id, k(s, {
                        role: "tabpanel",
                        "aria-labelledby": i.id
                    }))
                }
                k(this.$el, "aria-orientation", T(this.$el, this.selVertical) ? "vertical" : null)
            },
            methods: {
                index() {
                ...
                show(t) {
                    const e = this.toggles.filter(r => !T(r, qs)),
                        i = this.index(),
    ...
    var bc = {
            ...
            computed: {
                target: {
                    get: ({
                        target: t
                    }, e) => (t = ze(t || e.hash, e), t.length ? t : [e]),
                    observe: ({
                        target: t
                    }) => t
                }
            ...
            events: [{
                ...
                handler(t) {
                    this._preventClick = null, !(!pt(t) || ae(this._showState) || this.$el.disabled) && (m(this.$el, "focus"), z(document, ut, () => m(this.$el, "blur"), !0, e => !this.$el.contains(e.target)), v(this.mode, "click") && (this._preventClick = !0))
                }
            }, {
                ...
                handler(t) {
                    ...
                    if (!e && (!ae(this._showState) || t.type !== "blur" && T(this.$el, ":focus") || t.type === "blur" && T(this.$el, ":hover"))) {
                ...
                filter: ({
                    mode: t
                }) => ["click", "hover"].some(e => v(t, e)),
                handler(t) {
                    if (t.defaultPrevented) return;
                    const e = t.target.closest("a[href]"),
                        i = fe(e) && (!e.hash || T(this.target, e.hash));
                    (this._preventClick || i || e && !this.isToggled(this.target)) && t.preventDefault(), !this._preventClick && v(this.mode, "click") && (!e || i || t.defaultPrevented) && this.toggle()
                }
            }, {
                name: "mediachange",
                filter: ({
            ...
            methods: {
                async toggle(t) {
                    ...
                    if (Pt(this.$el, "aria-expanded") && (this.$el.ariaExpanded = !this.isToggled(this.target)), !this.queued) return this.toggleElement(this.target);
